...
class HumiditySensor(SensorBase):
    ...
    def read(self):
        '''Returns (ambient_temp C, rel_humidity)'''
    ...
    def labels(self):
        return "ambient temp C, relative humidity"
...
class BarometerSensor(SensorBase):
    ...
    def labels(self):
        return "ambient temperature, millibars"
...
class GyroscopeSensor(SensorBase):
    ...
    def labels(self):
        return "x deg/s, y deg/s , z deg/s"
